...
public class AddAuctionActivity extends AppBaseActivity implements
    ...
    private Spinner totaldays_spinner;
    private Spinner totalhrs_spinner;
    private String[] totaldays = {"1 Days", "2 Days", "3 Days", "4 Days", "5 Days", "6 Days", "7 Days"};
    private String[] totalhrs = {"1 Hours", "2 Hours", "3 Hours", "4 Hours", "5 Hours", "6 Hours", "7 Hours", "8 Hours", "9 Hours", "10 Hours", "11 Hours", "12 Hours"};
...
//        addImagesLyt.setOnClickListener(this);
        ...
        totaldays_spinner = findViewById(R.id.totaldays_spinner);
        totalhrs_spinner = findViewById(R.id.totalhrs_spinner);
...
//            adDeleteBtn.setVisibility(View.GONE);
    ...
    private void setHrsSpinner() {
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, totalhrs);
        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        totalhrs_spinner.setAdapter(dataAdapter);
        totalhrs_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
    ...
    private void setdaySpinner() {
        ArrayAdapter<String> dataAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, totaldays);
        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        totaldays_spinner.setAdapter(dataAdapter);
        totaldays_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
...
//                        spinnerChoiceSubCategory.setAdapter(dataAdapter1);
                        ...
                        ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>
                                (AddAuctionActivity.this, android.R.layout.simple_spinner_item, sub_categories);
                        dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        ...
                        Toast.makeText(AddAuctionActivity.this, "No Record Found!", Toast.LENGTH_LONG).show();
                    }
            ...
            public void onFailure(Call<SubCategoryResponseModel> call, Throwable t) {
                ...
                Toast.makeText(AddAuctionActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
                progress_circular.setVisibility(View.GONE);
            }
        });
    }
...
//        }
    ...
    private void addPost() {
        try {
            ...
            int days = totaldays_spinner.getSelectedItemPosition() + 1;
            int hour = totalhrs_spinner.getSelectedItemPosition() + 1;
            ...
            builder.addFormDataPart("auction", "1");
            builder.addFormDataPart("days", days + "");
            builder.addFormDataPart("hours", hour + "");
            ...
            if (adsImagesPath.size() == 0) {
                ...
                File coverImgFile = Utils.prepareFilePart(AddAuctionActivity.this, adsImagesPath.get(0));
...
//                    if (i != 0) {
                    ...
                    File file = Utils.prepareFilePart(AddAuctionActivity.this, adsImagesPath.get(i));
...
//                    }
            ...
            if (videoPath != null) {
                File file = Utils.prepareFilePart(AddAuctionActivity.this, videoPath);
    ...
    private void updatePost() {
        try {
            ...
            builder.addFormDataPart("showWhatsapp", "" + whatsApp);
            builder.addFormDataPart("age", age.getText().toString());
            builder.addFormDataPart("max_bid", price.getText().toString());
            builder.addFormDataPart("city", location1);
            builder.addFormDataPart("sex", sex);
            builder.addFormDataPart("vaccine_detail", vaccine.getText().toString());
            builder.addFormDataPart("country", "المملكة العربية السعودية");
...
//                        Log.i("post_update_bew", imageName + " --- "+file.getName());
...
//                    File file = new File(adsImagesPath.get(i));
                    if (upload) {
                        builder.addFormDataPart("images[]", file.getName(), RequestBody.create(MediaType.parse("multipart/form-data"), file));
//                        Log.i("post_update_bew",file.getName()+" --- upload");
                    } else {
//                        Log.i("post_update_bew", file.getName() + " --- filesave");
                    }
//                    }
                }
...
//            Bitmap bmThumbnail= ThumbnailUtils.createVideoThumbnail(videoPath.toString(), MediaStore.Images.Thumbnails.MICRO_KIND);

//            String strUri=Utils.saveToInternalStorage(AddAuctionActivity.this,bmThumbnail,Calendar.getInstance().getTimeInMillis()+"_IMG.png")
//            adsImages.add(Uri.parse(strUri));
            showImages(adsImages);
        }
...
//        addImagesLyt.setVisibility(View.GONE);
        ...
        adapterAdsImages = new AdapterAdsImages(images, this, this, this, this,this);
